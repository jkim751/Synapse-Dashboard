    ...
    <div className="flex flex-col gap-8 p-4">
      ...
      <div className="bg-white p-6 rounded-xl shadow">
        ...
        <div className="space-y-4">
          <button className="bg-orange-400 text-white px-4 py-2 rounded-xl hover:bg-blue-400">
            Generate Monthly Invoices
          </button>
          <button className="bg-green-600 text-white px-4 py-2 rounded-xl hover:bg-green-700 ml-4">
