...
-- CreateTable
CREATE TABLE "_NotificationToRecurringLesson" (
    "A" TEXT NOT NULL,
    "B" INTEGER NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_NotificationToRecurringLesson_AB_unique" ON "_NotificationToRecurringLesson"("A", "B");

-- CreateIndex
CREATE INDEX "_NotificationToRecurringLesson_B_index" ON "_NotificationToRecurringLesson"("B");
...
-- AddForeignKey
ALTER TABLE "_NotificationToRecurringLesson" ADD CONSTRAINT "_NotificationToRecurringLesson_A_fkey" FOREIGN KEY ("A") REFERENCES "notifications"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_NotificationToRecurringLesson" ADD CONSTRAINT "_NotificationToRecurringLesson_B_fkey" FOREIGN KEY ("B") REFERENCES "RecurringLesson"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- Add the following line to the file
ALTER TABLE "_SubjectToTeacher" REPLICA IDENTITY FULL;
